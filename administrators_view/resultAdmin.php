...
<a href="../administrator_controllers/administrator.php" class="back-button">戻る</a>
<a href="../administrator_controllers/admin_list.php" class="back-button">集計結果を表示する</a>
</body>
</html>
